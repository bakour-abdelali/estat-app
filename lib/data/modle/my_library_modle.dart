class MyLibraryModle {
  ...
  String? librarySummaryId;
  String? libraryUserId;
  String? libraryDateCreate;
  ...
  MyLibraryModle(
      ...
      this.avgEvaluation,
      this.librarySummaryId,
      this.libraryUserId,
      this.libraryDateCreate});

  MyLibraryModle.fromJson(Map<String, dynamic> json) {
    ...
    librarySummaryId = json['library_summary_id'];
    libraryUserId = json['library_user_id'];
    libraryDateCreate = json['library_date_create'];
  }
}
